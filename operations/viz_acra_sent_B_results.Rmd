...
```{r warning=F}
dname <- "results/sentiment_B/exp_classifiers/"
...
```{r warning=F}
dname <- "results/sentiment_B/exp_tolerance/"
...
```{r warning=F}
dname <- "results/sentiment_B/exp_nsamples/"
...
```{r}
dname <- "results/sentiment_B/exp_classifiers_noCK/"
